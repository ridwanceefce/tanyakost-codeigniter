          ...
          <div class="container-fluid">
            ...
            <button class="navbar-toggle collapsed" id="hamburger" 
              ...
              <a href="<?= base_url() ?>" class="navbar-brand">
                <img src="<?= base_url('assets/images/logo-takos-navbar-1.svg')  ?>" class="img-responsive logo-md hidden-xs" alt="Logo Tanyakost" >
                <img src="<?= base_url('assets/images/logo-takos.svg') ?>" class="img-responsive logo-xs visible-xs" alt="Logo Tanyakost" >
              </a>
            </div>
