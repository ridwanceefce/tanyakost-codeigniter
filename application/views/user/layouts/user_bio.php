              <div class="col-md-12" id="profil-bio">
                ...
                <div class="bio-control">
                  ...
                  <ul class="control">
                    ...
                    <li><a href="<?= base_url('user/kost/'.$user['id_user']) ?>"><span><i class="fa fa-home" aria-hidden="true"></i> Kosts</span><span class="badge pull-right">1</span></a></li>
                    <li><a href="<?= base_url('user/pesan/tampil/'.$user['id_user']) ?>"><span><i class="fa fa-envelope" aria-hidden="true"></i> Pesan</span><span class="badge pull-right">10</span></a></li>
                  </ul>
                </div> <!-- /.bio-control -->
                <hr class="hr-primary">
                <div class="settings">
                  ...
                  <ul class="profil-setting">
                    <li><a href="<?= base_url('user/ubah/'.$user['id_user']) ?>"><i class="fa fa-user" aria-hidden="true"></i>Ubah profil</a></li>
