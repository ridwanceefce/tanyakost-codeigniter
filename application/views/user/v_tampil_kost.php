...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?= base_url('assets/css/user-kosts.css') ?>" rel="stylesheet">
    <link href="<?= base_url('assets/css/user-bio.css') ?>" rel="stylesheet">
                          ...
                          <div class="box">
                            <div class="col-md-12">
                              <div class="row kost-label">
                                ...
                                <a href="<?= base_url('user/'.$user['id_user'].'/kost/'.$k->id_kost.'/ubah') ?>" class="btn btn-primary btn-xs">Ubah</a>
